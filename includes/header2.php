                ...
                <nav id="navbar-main" class="navbar navbar-expand-lg  navbar-light">
                    <div class="container">
                        <a href="#" class="navbar-brand">
                            <img src="images/osho-maitrey-dark.png" class="img-fluid" alt="Osho Maitrey">
                        </a>
                        <div class="collapse navbar-collapse d-flex justify-content-end" id="navbarNav">
                            ...
                            <ul class="navbar-nav ">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#">Audio Books
                                    </a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="lang text-end ms-4">
                            <img src="images/lang-switch.png" alt="" class="img-fluid">
                        </div>
                    </div>
                </nav>
            </div>
