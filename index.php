        ...
        <div class="hero-banner">
            <div class="hero-slider">
                <div class="slide-item">
                    <img src="images/hero-img.jpg" class="img-fluid">
                </div>
                <div class="slide-item">
                    <img src="images/hero-img.jpg" class="img-fluid">
                </div>
            ...
            <div class="hero-content text-black">
                <div class="container">
                    <div class="banner-content">
                        <h1>Never Born – Never Died Only visited this planet Earth</h1>
                        <p>I don’t have any biography. And whatsoever is thought to be biography is utterly meaningless.
                            On what date I was born, in what country I was born, does not matter. What matters is what I
                            am now, right here.</p>
        ...
        <section class="ab-sec">
            ...
            <div class="ab-slider">
                <div class="slide-item ab-card">
                    <a href="#">
                        <div class="ab-img">
                            <img src="images/ab.png" class="img-fluid">
                        </div>
                        <div class="ab-brief">
                            <ul class="meta-tag">
                ...
                <div class="slide-item ab-card">
                    <a href="#">
                        <div class="ab-img">
                            <img src="images/ab1.png" class="img-fluid">
                        </div>
                        <div class="ab-brief">
                            <ul class="meta-tag">
                                <li>November 28, 2022</li>
                ...
                <div class="slide-item ab-card">
                    <a href="#">
                        <div class="ab-img">
                            <img src="images/ab2.png" class="img-fluid">
                        </div>
                        <div class="ab-brief">
                            <ul class="meta-tag">
                                <li>November 28, 2022</li>
                ...
                <div class="slide-item ab-card">
                    <a href="#">
                        <div class="ab-img">
                            <img src="images/ab3.png" class="img-fluid">
                        </div>
                        <div class="ab-brief">
                            <ul class="meta-tag">
                                <li>November 28, 2022</li>
                ...
                <div class="slide-item ab-card">
                    <a href="#">
                        <div class="ab-img">
                            <img src="images/ab4.png" class="img-fluid">
                        </div>
                        <div class="ab-brief">
                            <ul class="meta-tag">
                                <li>November 28, 2022</li>
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="slider-img">
                                <img src="images/slider-img.png" class="slide-img" alt="">
                            </div>
                        </div>
...
<div class="bg-attachment position-relative" style="background:url(images/bga.jpg)">
    <div class="container">
        <section class="bga-sec text-center large-p">
            <figure>
                <img src="images/osho-white.png" class="img-fluid">
            </figure>
            <div class="bga-text">
        ...
        <section class="events-sec">
            ...
            <div class="event-brief">
                <div class="row g-0 align-items-center">
                    <div class="col-lg-3">
                        <div class="eb-img">
                            <img src="images/osho.png" class="img-fluid" alt="">
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="eb-time">
